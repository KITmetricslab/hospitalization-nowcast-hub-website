...
<br>
In this context we note that some German states (Bundesländer) also publish their own hospitalization incidences which follow different definition (e.g., temporal aggregation by date of hospitalization rather than *Meldedatum* of the infection; see [this news item by NDR](https://www.ndr.de/nachrichten/info/Nach-MPK-Beschluss-Verwirrung-um-Hospitalisierungsinzidenz,hospitalisierungsinzidenz100.html)). We focus exclusively on the indicator provided by RKI.
</blockquote>
</details>
...
This platform is run by members of the [Chair of Statistics and Econometrics](https://statistik.econ.kit.edu/index.php){target="_blank"} at Karlsruhe Institute of Technology and the [Computational Statistics Group](https://www.h-its.org/de/forschung/cst/){target="_blank"} at Heidelberg Institute for Theoretical Studies. Several other independent groups from academia and media contribute nowcasts:
...
- [Department of Mathematics, Stockholm University](https://www.su.se/english/profiles/fegu7762-1.554768)
