...
<br>
A more detailed account on this question can be found in this [news item by German public broadcaster SWR](https://www.swr.de/swraktuell/rheinland-pfalz/mit-oder-wegen-corona-im-krankenhaus-100.html){target="_blank"} (in German). According to this article, in the German state of Rheinland-Pfalz, approximately on third of the hospitalization incidence was due to cases where COVID-19 was the primary reason of hospitalization.
</blockquote>
</details>
